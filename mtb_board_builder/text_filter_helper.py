...
measure_tracking_board_ingest = query_helper("query($board_id:Int!,$col_id:String!){boards(ids:[$board_id]){items{ id column_values(ids:[$col_id]){text}}}}",{'board_id':measure_tracking_board_id,'col_id':'connect_boards7'})
measure_tracking_board_list = measure_tracking_board_ingest['data']['boards'][0]['items']
